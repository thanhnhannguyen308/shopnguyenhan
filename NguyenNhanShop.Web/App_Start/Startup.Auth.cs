...
[assembly: OwinStartup(typeof(NguyenNhanShop.Web.App_Start.Startup))]

namespace NguyenNhanShop.Web.App_Start
{
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.CreatePerOwinContext(NguyenNhanShopDbContext.Create);
        ...
        {
            var userStore = new UserStore<ApplicationUser>(context.Get<NguyenNhanShopDbContext>());
